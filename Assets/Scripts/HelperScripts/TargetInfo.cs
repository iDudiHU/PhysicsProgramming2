...
{
	/// <summary>
	/// If a target is in range, this method will return true, you can provide a posiiton and direction for the ray, as well as the range and the layermask, Provides what was hit as HitInfo.
	/// </summary>
